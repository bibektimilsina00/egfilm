...
const WORKING_PROVIDERS = [
  ...
  // Aggregators
  {
    ...
    isDefault: false,
    sortOrder: 12,
    movieTemplate: 'https://2embed.skin/embed/movie/{tmdbId}',
    tvTemplate: 'https://2embed.skin/embed/tv/{tmdbId}/{season}/{episode}',
    supportsImdb: false,
    supportsTmdb: true,
    hasMultiQuality: true,
    hasSubtitles: true,
    hasAutoplay: false,
    requiresAuth: false,
    description: 'Multi-server embed alternate domain',
    homepage: 'https://2embed.skin',
  },
  {
    name: 'MultiEmbed',
    slug: 'multiembed',
