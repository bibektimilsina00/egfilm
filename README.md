# 🎬 StreamFlix - Movie & TV Streaming Platform# 🎬 StreamFlix -## ✨ Features
...
<div align="center">### 🎯 Core Features
  ...
  ![StreamFlix](https://img.shields.io/badge/StreamFlix-v2.0-blue?style=for-the-badge)- **🔄 Multi-Server Support** - 5 different video sources for reliability (VidSrc, 2Embed, SuperEmbed, etc.)

  ![Next.js](https://img.shields.io/badge/Next.js-15.5.4-black?style=for-the-badge&logo=next.js)- **👥 Watch Together** - Watch with friends in real-time with video/voice calling and chat

  ![TypeScript](https://img.shields.io/badge/TypeScript-5.0-blue?style=for-the-badge&logo=typescript)- **📺 Episode Selection** - Easy season and episode picker for TV shows

  ![Tailwind](https://img.shields.io/badge/Tailwind-4.0-38bdf8?style=for-the-badge&logo=tailwind-css)- **🔍 Advanced Search** - Instant search with trending content fallback

  ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-16-316192?style=for-the-badge&logo=postgresql)- **💝 Watchlist** - Save your favorite movies and TV shows
