...
import { Instagram, Twitter, Mail, BookOpen, LayoutGrid, Heart, Film, Tv, Activity } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <FooterLink href="/browse" icon={LayoutGrid} text="All Channels" />
                            <FooterLink href="/favorites" icon={Heart} text="Favorites" />
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <FooterLink href={EGSPORT_URL} icon={Activity} text="Sport" external />
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            One account across EGFilm, EGSport and EGTV. Channel data via the iptv-org project.
                        </p>
                    </div>
                </div>

                <div className="border-t border-gray-800 mt-10 pt-6 text-center text-xs text-gray-500">
                    &copy; {year} EGFilm Network. EGTV is part of the EGFilm family.
                </div>
            </div>
        </footer>
    );
